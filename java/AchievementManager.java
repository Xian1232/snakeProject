...
public class AchievementManager {
    ...
    private Achievement highScorerAchievement = new Achievement("even_higher_score", "Higher Scorer", "Score over 10 points");
    ...
    private void loadAchievements(Context context) {
        ...
        boolean isHighScorerUnlocked = prefs.getBoolean("higher_scorer_unlocked", false);
        ...
        Achievement highScorerAchievement = new Achievement("even_higher_scorer", highScorerName, highScorerDesc);
